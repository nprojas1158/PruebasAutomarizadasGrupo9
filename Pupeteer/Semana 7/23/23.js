...
(async () => {
    ...
    }
    {
        const targetPage = page;
        await puppeteer.Locator.race([
            targetPage.locator('div:nth-of-type(2) > div.gh-radio-button'),
            targetPage.locator('::-p-xpath(//*[@id=\\"ember238\\"]/div/div[1]/fieldset/div[2]/div[2]/div[1])'),
            targetPage.locator(':scope >>> div:nth-of-type(2) > div.gh-radio-button')
        ])
            .setTimeout(timeout)
            .click({
              offset: {
    ...
    }
    {
        ...
        await puppeteer.Locator.race([
            ...
            .setTimeout(timeout)
            .fill(faker.string.symbol(4)+faker.internet.email());
            await page.screenshot({path: './results/pagina10.png'});
    }
    {
        const targetPage = page;
        await puppeteer.Locator.race([
            targetPage.locator('#ember238 > div span'),
            targetPage.locator('::-p-xpath(//*[@id=\\"ember245\\"]/span)'),
            targetPage.locator(':scope >>> #ember238 > div span'),
