...
describe("Cypress POM Test Suite", function () {
    ...
    it('Escenario 22: HTML Valido boton footer ', function () {
        ...
        cy.fixture('mock_data.json').then(data => {
            ...
            cy.get('a').then(($a) => {
                ...
                cy.get('#post-setting-codeinjection-foot > .CodeMirror > .CodeMirror-scroll').type("<button id='prueba'>prueba</button>")
                
                //Then I excerpt is valido

                cy.get('button').should('exist','prueba');
