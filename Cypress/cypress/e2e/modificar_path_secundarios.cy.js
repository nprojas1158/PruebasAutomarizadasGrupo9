...
describe("Cypress POM Test Suite", function () {
  ...
  it ('Escenario 1: Ingresar al boton Secundary y editar un Path con datos correctos ' , function () {
    ...
    cy.get('a').then(($a)=>{
      ...
      cy.screenshot();
      cy.get(':r86:').type(title);
      cy.screenshot();
      cy.get('#\:r11\:').type('/#/posts/');
      cy.screenshot();
    ...
    cy.get('#\:r10\:').should('contain',title); 
