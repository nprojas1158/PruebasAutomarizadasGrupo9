...
describe("Cypress POM Test Suite", function () {
    ...
    it('Escenario 15: Crear Post solo con el titulo de mas de 2000 caracteres ', function () {
        // Cargar el archivo Json
        cy.fixture('mock_data.json').then(data => {
            const title = data[1].description
            ...
            cy.get('a').then(($a) => {
                ...
                cy.get('textarea[placeholder="Post title"]').type(description);
