...
describe("Cypress POM Test Suite", function () {
    ...
    it('Escenario 2: Crear Post solo con el titulo sin description ', function () {
...
cy.get('#ember286 > .gh-post-list-cta')