...
describe("Cypress POM Test Suite", function () {
  ...
  it ('Escenario 3: Ingresar al boton Secundary y editar un Path con datos Invalidos ' , function () {
    ...
    cy.get('a').then(($a)=>{
      ...
      cy.screenshot();
      cy.get('.w-4 h-4 dark:text-white ').click();
      cy.screenshot();
    ...
    //Then I p have text description
        cy.get('p').should('contain','Clear path'); 
        cy.screenshot();
